...
namespace RacerData.Themes.UI.Providers
{
    ...
    class ThemesExtenderProvider : Component, IExtenderProvider
    {
        ...
        private IDictionary<string, ITheme> _themeList;
        ...
        public ThemesExtenderProvider()
        {
            ...
            _themeList = new Dictionary<string, ITheme>
            {
        ...
        private void ApplyTheme(Control control, ITheme theme)
        {
