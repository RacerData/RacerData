namespace RacerData.WinForms.Editors
{
    partial class AppAppearanceEditor
    {
        ...
        {
            RacerData.WinForms.Models.SimpleColorTable simpleColorTable1 = new RacerData.WinForms.Models.SimpleColorTable();
            this.txtName = new System.Windows.Forms.TextBox();
            this.lblName = new System.Windows.Forms.Label();
            this.pnlSubEditors = new System.Windows.Forms.Panel();
            this.colorTableAppearanceEditor = new RacerData.WinForms.Editors.ColorTableAppearanceEditor();
            this.listAppearanceEditor = new RacerData.WinForms.Editors.ListAppearanceEditor();
            this.dialogAppearanceEditor = new RacerData.WinForms.Editors.DialogAppearanceEditor();
            this.buttonAppearanceEditor = new RacerData.WinForms.Editors.ButtonAppearanceEditor();
            this.darkAccentAppearanceEditor = new RacerData.WinForms.Editors.AppearanceEditor();
            this.lightAccentAppearanceEditor = new RacerData.WinForms.Editors.AppearanceEditor();
            this.workspaceAppearanceEditor = new RacerData.WinForms.Editors.WorkspaceAppearanceEditor();
