...
{
    public class Theme : IKeyedItem<Guid>, INotifyPropertyChanged
    {
        #region events
        ...
        private FontInfo _viewFont;
        public virtual FontInfo ViewFont
        {
            get
            {
                return _viewFont;
        ...
        private FontInfo _headerFont;
        public virtual FontInfo HeaderFont
        {
            get
            {
                return _headerFont;
        ...
        private FontInfo _gridColumnHeaderFont;
        public virtual FontInfo GridColumnHeaderFont
        {
            get
            {
        ...
        private FontInfo _gridFont;
        public virtual FontInfo GridFont
        {
            get
            {
                return _gridFont;
