...
namespace RacerData.NascarApi.Client.Extensions
{
    ...
    {
        public static IEnumerable<VehicleLapTime> GetVehicleLapTimes(this LapTimeData lapTimes, string vehicleId)
        {
            return GetVehicleLapTimes(lapTimes, new List<string>() { vehicleId });
        }

        public static IEnumerable<VehicleLapTime> GetVehicleLapTimes(this LapTimeData lapTimes, IList<string> vehicleIds)
        {
            return lapTimes.VehicleLapTimes.Where(v => vehicleIds.Contains(v.VehicleId));
        }

        public static IEnumerable<VehicleLapTime> GetVehicleLapTimes(this LapTimeData lapTimes, IList<string> vehicleIds, int startLap = 1, int endLap = 999)
        {
