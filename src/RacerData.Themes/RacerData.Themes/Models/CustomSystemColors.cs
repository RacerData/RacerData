...
namespace RacerData.Themes.Models
{
    ...
    public class CustomSystemColors : IAppearance
    {
        #region events
        ...
        [JsonIgnore()]
        public static CustomSystemColors DefaultSystemColors { get; private set; }
        ...
        static CustomSystemColors()
        {
            DefaultSystemColors = JsonConvert.DeserializeObject<CustomSystemColors>(Properties.Resources.DefaultColorsJson);
        }
