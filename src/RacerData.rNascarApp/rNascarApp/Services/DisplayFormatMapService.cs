...
{
    // TODO: Use Serializer/FileLoader
    public class DisplayFormatMapService : IDisplayFormatMapService
    {
        #region fields

        private readonly IViewDisplayFormatFactory _displayFormatFactory = null;
        ...
        public DisplayFormatMapService(IViewDisplayFormatFactory displayFormatFactory)
        {
            _displayFormatFactory = displayFormatFactory ?? throw new ArgumentNullException(nameof(displayFormatFactory));
        ...
        protected virtual IList<ViewDisplayFormat> LoadDisplayFormats()
        {
            ...
            try
            {
                ...
                {
                    formats = _displayFormatFactory.GetViewDisplayFormats();
                }
                else
                {
            ...
            {
                throw new Exception($"Error deserializing the Display Format file:\r\n\r\n{ex.Message}\r\n\r\n" +
                    $"File: {filePath}", ex);
            }
            catch (Exception ex)
            {
                throw new Exception("Error loading Display Format Mapping file", ex);
            }
        ...
        protected virtual IDictionary<ViewDataMember, ViewDisplayFormat> LoadMap()
        {
            ...
            {
                throw new Exception($"Error deserializing the Display Format Mapping file:\r\n\r\n{ex.Message}\r\n\r\n" +
                    $"File: {filePath}", ex);
            }
