...
using NascarApiLiveFeed = RacerData.NascarApi.Models.LivePoints;

namespace RacerData.NascarApi.Client.Mapping.LivePoints
{
    public class LivePointsDataMappingProfile : Profile
    {
        public LivePointsDataMappingProfile()
        {
            CreateMap<NascarApiLiveFeed.RootObject, LivePointsData>()
               ...
               .ForMember(m => m.DelataNext, opts => opts.MapFrom(src => src.delta_next))
