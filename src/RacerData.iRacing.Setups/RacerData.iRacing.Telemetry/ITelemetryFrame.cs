namespace RacerData.iRacing.Telemetry
{
    public interface ITelemetryFrame
    {
        ...
        irsdk_TrkLoc PlayerTrackSurface { get; set; }
        irsdk_TrkSurf PlayerTrackSurfaceMaterial { get; set; }
        ...
        irsdk_PitSvStatus PlayerCarPitSvStatus { get; set; }
        ...
        irsdk_EngineWarnings EngineWarnings { get; set; }
        float FuelLevel { get; set; }
        float FuelLevelPct { get; set; }
        irsdk_PitSvFlags PitSvFlags { get; set; }
