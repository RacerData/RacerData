...
namespace RacerData.WinForms.Editors
{
    partial class ButtonAppearanceEditor
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.mouseOverColorEditor = new RacerData.WinForms.Editors.ColorEditor();
            this.mouseDownColorEditor = new RacerData.WinForms.Editors.ColorEditor();
            this.borderColorEditor = new RacerData.WinForms.Editors.ColorEditor();
