...
namespace RacerData.Drawing
{
    //
    // Summary:
    //     Each property of the CustomSystemColors class is a System.Drawing.Color
    //     structure that is the color of a Windows display element.
    public class CustomSystemColors
    {
        private const string DefaultColors = "";
